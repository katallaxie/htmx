...
func MagnifyingGlassMinusMicroSolid(p icons.IconProps) htmx.Node {
	return htmx.SVG(
        ...
        htmx.Path(
            htmx.Attribute("d", "M8.75 6.25L5.25 6.25C4.83579 6.25 4.5 6.58579 4.5 7C4.5 7.41421 4.83579 7.75 5.25 7.75L8.75 7.75C9.16421 7.75 9.5 7.41421 9.5 7C9.5 6.58579 9.16421 6.25 8.75 6.25Z"),
        ),
        htmx.Path(
