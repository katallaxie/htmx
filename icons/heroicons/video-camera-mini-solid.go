...
func VideoCameraMiniSolid(p icons.IconProps) htmx.Node {
	return htmx.SVG(
        ...
        htmx.Path(
            htmx.Attribute("d", "M3.25 4C2.00736 4 1 5.00736 1 6.25V13.75C1 14.9926 2.00736 16 3.25 16H10.75C11.9926 16 13 14.9926 13 13.75V6.25C13 5.00736 11.9926 4 10.75 4H3.25Z"),
        ),
        htmx.Path(
