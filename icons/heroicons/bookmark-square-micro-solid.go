...
func BookmarkSquareMicroSolid(p icons.IconProps) htmx.Node {
	return htmx.SVG(
        ...
        htmx.Path(
            htmx.Attribute("d", "M4 2C2.89543 2 2 2.89543 2 4V12C2 13.1046 2.89543 14 4 14H12C13.1046 14 14 13.1046 14 12V4C14 2.89543 13.1046 2 12 2H4ZM5 4.25C5 3.83579 5.33579 3.5 5.75 3.5H10.25C10.6642 3.5 11 3.83579 11 4.25L11.0001 10.2499C11.0001 10.5533 10.8174 10.8268 10.5371 10.9429C10.2569 11.0589 9.93428 10.9948 9.71978 10.7803L8.00011 9.0606L6.28044 10.7803C6.06595 10.9948 5.74336 11.0589 5.4631 10.9429C5.18285 10.8268 5.00011 10.5533 5.00011 10.2499L5 4.25Z"),
        ),
    )
}
